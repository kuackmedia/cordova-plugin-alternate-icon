...
function updateAndroidManifest(androidRoot, iconFiles) {
    ...
    xml2js.parseString(manifestString, (err, manifest) => {
        ...
        applicationRoot['activity-alias'] = getActivityAliasesForIcons(packageName, activityAliases, iconFiles);
...
function getActivityAliasesForIcons(packageName, activityAliases, iconFiles) {
